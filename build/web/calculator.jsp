                                ...
                                <form action="calculator.jsp" method="post">
                                    ...
                                    <div class="mt-10">
                                        <input type="number" name="num2" placeholder="Number 2"
                                               onfocus="this.placeholder = ''" onblur="this.placeholder = 'Number 2'" required
                                               class="single-input">
                                    </div>
                                    <br/>
                                    <div>
                                        <button type="submit" name="operation" value="/" class="boxed-btn3">/</button>
                                        <button type="submit" name="operation" value="*" class="boxed-btn3">*</button>
                                        <button type="submit" name="operation" value="+" class="boxed-btn3">+</button>
                                        <button type="submit" name="operation" value="-" class="boxed-btn3">-</button>
                                    </div>
                                    <div class="mt-10">
                                        <input type="number" name="result" placeholder="Result" value="<%= result%>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Result'" required
                                               class="single-input">
                                    </div>
                                </form>
                            </div>
